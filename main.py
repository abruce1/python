...
end = st.sidebar.date_input("End  start date", datetime.date(2021, 3, 11))

# Page title
st.title('Stock Price')
about = """
We built this site using Python and steamlit with code we sourced and pieced togeather from the internet. 
...
sentiment_raw = []
for reply in data:
    pltr_index = reply.body.lower().find('pltr')
...
comparing the results with the stock price, to see if there is actually a correlation between the 'mentions' 
and the price of a certain stock
"""
...
st.title('THANK YOU')
thankyou = """
We learned a lot while building this app. Thank you to Professor N , our TA and the world wide web for 
all the support this semester, we couldent have done it without you all!
"""
